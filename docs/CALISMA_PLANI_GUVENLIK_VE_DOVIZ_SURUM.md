...
| # | Görev | Durum | Not |
|---|--------|--------|-----|
| 2.1.1 | Exchange endpoint’lerinin route ve response modelleri dokümante edilsin; Swagger açıklamaları güncellensin | ☐ | /api/v1/Exchange (örn. /exchange), Vaults, Offices, Dealers vb. |
