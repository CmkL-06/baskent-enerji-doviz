...
using AnasıTAS_Deniz.Entity.Modals.RequestModals.ExchangeService.Blockchain;
using AnasıTAS_Deniz.Entity.Modals.ViewModals.ExchangeOFfice;
using AnasıTAS_Deniz.Entity.Modals.ViewModals.ExchangeOffice.Blockchain;
...
namespace AnasıTAS_Deniz.API.Controllers.ExchangeOffice
{
        ...
        public async Task<ActionResult<bool>> CheckUserOfficeAccess(Guid userId, Guid officeId)
    {
        ...
        public async Task<ActionResult<List<AnasıTAS_Deniz.Entity.Modals.ViewModals.User.vm_user>>> GetOfficeUsers(Guid officeId)
    {
        try
        {
