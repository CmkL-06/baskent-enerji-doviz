...
using AnasıTAS_Deniz.API;
using AnasıTAS_Deniz.API.Services;
using AnasıTAS_Deniz.Business.Exceptions;
using AnasıTAS_Deniz.Business.Extensions;
...
using AnasıTAS_Deniz.Business.Infrastructure.Cache;
...
using AnasıTAS_Deniz.Business.Infrastructure.ExchangeOffice.Blockchain;
using AnasıTAS_Deniz.Business.Services.ExchangeOffice.AutoRate;
using AnasıTAS_Deniz.API.HostedServices;
using AnasıTAS_Deniz.Business.Infrastructure.Site.General;
using AnasıTAS_Deniz.Business.Infrastructure.Site.Language;
using AnasıTAS_Deniz.Business.Infrastructure.Site.Menu;
using AnasıTAS_Deniz.Business.Infrastructure.Site.Page;
using AnasıTAS_Deniz.Business.Infrastructure.Site.Slider;
using AnasıTAS_Deniz.Business.Infrastructure.Site.Tag;
using AnasıTAS_Deniz.Business.Infrastructure.Site.Theme;
using AnasıTAS_Deniz.Business.Infrastructure.Site;
using AnasıTAS_Deniz.Business.Infrastructure.User;
using AnasıTAS_Deniz.Business.Services.Blog;
using AnasıTAS_Deniz.Business.Services.Blog.Article;
using AnasıTAS_Deniz.Business.Services.Blog.Category;
using AnasıTAS_Deniz.Business.Services.Cache;
using AnasıTAS_Deniz.Business.Services.Coin;
using AnasıTAS_Deniz.Business.Services.Email;
using AnasıTAS_Deniz.Business.Services.ExchangeOffice;
using AnasıTAS_Deniz.Business.Services.ExchangeOffice.Expense;
using AnasıTAS_Deniz.Business.Services.ExchangeOffice.Office;
using AnasıTAS_Deniz.Business.Services.ExchangeOffice.Party;
using AnasıTAS_Deniz.Business.Services.ExchangeOffice.Blockchain;
using AnasıTAS_Deniz.Business.Services.Permission;
using AnasıTAS_Deniz.Business.Services.Site.General;
using AnasıTAS_Deniz.Business.Services.Site.Language;
using AnasıTAS_Deniz.Business.Services.Site.Menu;
using AnasıTAS_Deniz.Business.Services.Site.Page;
using AnasıTAS_Deniz.Business.Services.Site.Slider;
using AnasıTAS_Deniz.Business.Services.Site.Tag;
using AnasıTAS_Deniz.Business.Services.Site.Theme;
using AnasıTAS_Deniz.Business.Services.Site;
using AnasıTAS_Deniz.Business.Services.User;
...
builder.Services.AddDbContext<AnasıTAS_DenizDbContext>(options =>
{
...
.AddJwtBearer(options =>
{
    ...
    options.Events = new JwtBearerEvents
    {
        ...
        {
            var dbContext = context.HttpContext.RequestServices.GetRequiredService<AnasıTAS_Deniz.Data.Contexts.AnasıTAS_DenizDbContext>();
