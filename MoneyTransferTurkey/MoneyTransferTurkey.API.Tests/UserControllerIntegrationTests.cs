...
public class UserControllerIntegrationTests : IClassFixture<MoneyTransferTurkeyWebApplicationFactory>
{
    private readonly HttpClient _client;
    private static readonly JsonSerializerOptions JsonOptions = new() { PropertyNameCaseInsensitive = true };

    public UserControllerIntegrationTests(MoneyTransferTurkeyWebApplicationFactory factory)
    {
