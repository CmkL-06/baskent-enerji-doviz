...
namespace MoneyTransferTurkey.API.Controllers.Coin
{
    ...
    public class CoinController : ControllerBase
    {
        ...
        public CoinController(CoinPriceService coinPriceService, ICoinServiceCommand coinServiceCommand, ICoinServiceQuery coinServiceQuery, MoneyTransferTurkeyDbContext dbContext)
        {
