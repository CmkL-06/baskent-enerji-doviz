...
using MoneyTransferTurkey.Business.Tools;
using MoneyTransferTurkey.Data.Contexts;
using MoneyTransferTurkey.Entity.Entities.Site.Form;
using MoneyTransferTurkey.Entity.Modals.RequestModals.Site.Form;
...
namespace MoneyTransferTurkey.API.Controllers.Site
{
    ...
    public class FormController : ControllerBase
    {
        ...
        public FormController(MoneyTransferTurkeyDbContext dbContext, IMapper mapper, ValidationService validationService)
        {
