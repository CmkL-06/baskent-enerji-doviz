...
using MoneyTransferTurkey.Entity.Modals.RequestModals.Site.Menu;
using MoneyTransferTurkey.Entity.Modals.RequestModals.Site.Page;
...
using MoneyTransferTurkey.Entity.Modals.ResponseModals.Form;
...
using MoneyTransferTurkey.Entity.Modals.ResponseModals.Site.Menu;
...
using MoneyTransferTurkey.Entity.Modals.ViewModals.Menu;
...
namespace MoneyTransferTurkey.Business.Extensions
{
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile()
        {
          ...
          //  CreateMap<rsp_category_guest, Blog_Category>();
            ...
            CreateMap<User, MoneyTransferTurkey.Entity.Modals.ViewModals.User.vm_user>();
