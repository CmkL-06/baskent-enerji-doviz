...
namespace MoneyTransferTurkey.Business.Services.User
{
    public class UserServiceCommand : IUserServiceCommand
    {
        ...
        public UserServiceCommand(MoneyTransferTurkeyDbContext smileMedicalDbContext, IConfiguration configuration, IEmailSender emailSender, ValidationService validationService, IMapper mapper)
        {
