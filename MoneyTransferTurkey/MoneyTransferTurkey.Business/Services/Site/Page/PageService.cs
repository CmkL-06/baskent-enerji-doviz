...
using PageEntity = MoneyTransferTurkey.Entity.Entities.Site.Page.Page;
using MoneyTransferTurkey.Entity.Entities.Site.Page;
using MoneyTransferTurkey.Entity.Modals.RequestModals.Site.Page;

namespace MoneyTransferTurkey.Business.Services.Site.Page
{
    public class PageService : IPageService
    {
        ...
        public PageService(MoneyTransferTurkeyDbContext dbContext, IMapper mapper)
        {
