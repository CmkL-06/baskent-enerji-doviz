...
namespace MoneyTransferTurkey.Business.Services.ExchangeOffice.Office
{
    public class UserOfficeService : IUserOfficeService
    {
        ...
        public UserOfficeService(MoneyTransferTurkeyDbContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
        ...
        public async Task<List<MoneyTransferTurkey.Entity.Modals.ViewModals.User.vm_user>> GetUsersByOfficeAsync(Guid officeId)
        {
            ...
            return _mapper.Map<List<MoneyTransferTurkey.Entity.Modals.ViewModals.User.vm_user>>(users);
        }
    }
}