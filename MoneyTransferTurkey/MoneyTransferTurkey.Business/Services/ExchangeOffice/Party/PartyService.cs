...
namespace MoneyTransferTurkey.Business.Services.ExchangeOffice.Party
{
    public class PartyService : IPartyService
    {
        ...
        public PartyService(MoneyTransferTurkeyDbContext context, ILogger<PartyService> logger, ValidationService validationService, ICacheClearService cacheClearService)
        {
            _context = context;
            _logger = logger;
