...
namespace MoneyTransferTurkey.Business.Services.ExchangeOffice.Party
{
    public class PartyAccountService : IPartyAccountService
    {
        ...
        public PartyAccountService(MoneyTransferTurkeyDbContext context, ILogger<PartyAccountService> logger, ValidationService validationService, IVaultService vaultService)
        {
            _context = context;
            _logger = logger;
