...
namespace MoneyTransferTurkey.Business.Services.ExchangeOffice.Expense
{
    public class ExpenseDefinitionService : IExpenseDefinitionService
    {
        ...
        public ExpenseDefinitionService(MoneyTransferTurkeyDbContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
