...
/// </summary>
public class ThemeControllerIntegrationTests : IClassFixture<SmileMedicalWebApplicationFactory>
{
    private readonly HttpClient _client;

    public ThemeControllerIntegrationTests(SmileMedicalWebApplicationFactory factory)
    {
