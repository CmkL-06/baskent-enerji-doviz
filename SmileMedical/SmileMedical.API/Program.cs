...
using SmileMedical.API;
using SmileMedical.API.Services;
using SmileMedical.Business.Exceptions;
using SmileMedical.Business.Extensions;
using SmileMedical.Business.Hubs;
using SmileMedical.Business.Infrastructure.Blog.Article;
using SmileMedical.Business.Infrastructure.Blog.Category;
using SmileMedical.Business.Infrastructure.Cache;
using SmileMedical.Business.Infrastructure.Coin;
using SmileMedical.Business.Infrastructure.Email;
using SmileMedical.Business.Infrastructure.ExchangeOffice;
using SmileMedical.Business.Infrastructure.ExchangeOffice.Expense;
using SmileMedical.Business.Infrastructure.ExchangeOffice.Office;
using SmileMedical.Business.Infrastructure.ExchangeOffice.Party;
using SmileMedical.Business.Infrastructure.ExchangeOffice.Blockchain;
using SmileMedical.Business.Services.ExchangeOffice.AutoRate;
using SmileMedical.API.HostedServices;
...
using SmileMedical.Business.Infrastructure.Site.Page;
using SmileMedical.Business.Infrastructure.Site.Slider;
using SmileMedical.Business.Infrastructure.Site.Tag;
...
using SmileMedical.Business.Services.Blog;
using SmileMedical.Business.Services.Blog.Article;
using SmileMedical.Business.Services.Blog.Category;
using SmileMedical.Business.Services.Cache;
using SmileMedical.Business.Services.Coin;
using SmileMedical.Business.Services.Email;
using SmileMedical.Business.Services.ExchangeOffice;
using SmileMedical.Business.Services.ExchangeOffice.Expense;
using SmileMedical.Business.Services.ExchangeOffice.Office;
using SmileMedical.Business.Services.ExchangeOffice.Party;
using SmileMedical.Business.Services.ExchangeOffice.Blockchain;
using SmileMedical.Business.Services.Permission;
using SmileMedical.Business.Services.Site.General;
using SmileMedical.Business.Services.Site.Language;
using SmileMedical.Business.Services.Site.Menu;
using SmileMedical.Business.Services.Site.Page;
using SmileMedical.Business.Services.Site.Slider;
using SmileMedical.Business.Services.Site.Tag;
using SmileMedical.Business.Services.Site.Theme;
using SmileMedical.Business.Services.Site;
using SmileMedical.Business.Services.User;
...
.AddJwtBearer(options =>
{
    ...
    options.Events = new JwtBearerEvents
    {
        ...
        {
            var dbContext = context.HttpContext.RequestServices.GetRequiredService<SmileMedical.Data.Contexts.SmileMedicalDbContext>();
