...
using SmileMedical.Entity.Modals.RequestModals.ExchangeService.Blockchain;
using SmileMedical.Entity.Modals.ViewModals.ExchangeOFfice;
using SmileMedical.Entity.Modals.ViewModals.ExchangeOffice.Blockchain;
...
namespace SmileMedical.API.Controllers.ExchangeOffice
{
        ...
        public async Task<ActionResult<bool>> CheckUserOfficeAccess(Guid userId, Guid officeId)
    {
        ...
        public async Task<ActionResult<List<SmileMedical.Entity.Modals.ViewModals.User.vm_user>>> GetOfficeUsers(Guid officeId)
    {
        try
        {
