...
namespace SmileMedical.Business.Services.ExchangeOffice.Party
{
    public class PartyService : IPartyService
    {
        ...
        public PartyService(SmileMedicalDbContext context, ILogger<PartyService> logger, ValidationService validationService, ICacheClearService cacheClearService)
        {
            _context = context;
            _logger = logger;
