...
## 3. Asla kopya oluşturulmaz

- **Amaç:** Veriyi tek yerde toplamak; dağınık kopya ve yedek oluşmasın.
- **Kural:** **ASLA KOPYA OLUŞTURULMAZ.** Tüm işlemler yalnızca **taşıma (move)** ile yapılır.
- Gereksiz **copy** veya yedek oluşturulmaz. Script’ler sadece **Move-Item** kullanır; **Copy-Item** kullanılmaz.
