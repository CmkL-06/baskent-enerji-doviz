...
using SmileMedical.Entity.Modals.RequestModals.Site.Form;
...
namespace SmileMedical.API.Controllers.Site
{
    ...
    public class FormController : ControllerBase
    {
        ...
        public FormController(SmileMedicalDbContext dbContext, IMapper mapper, ValidationService validationService)
        {
