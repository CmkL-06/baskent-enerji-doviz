...
using SmileMedical.Entity.Modals.RequestModals.Site.Reports;
using System;
...
{
    public class SmileMedicalDbContext : DbContext
    {
        public SmileMedicalDbContext(DbContextOptions<SmileMedicalDbContext> options) : base(options)
        { }
