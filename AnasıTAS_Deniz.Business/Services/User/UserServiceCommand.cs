...
namespace AnasıTAS_Deniz.Business.Services.User
{
    public class UserServiceCommand : IUserServiceCommand
    {
        ...
        public UserServiceCommand(AnasıTAS_DenizDbContext smileMedicalDbContext, IConfiguration configuration, IEmailSender emailSender, ValidationService validationService, IMapper mapper)
        {
