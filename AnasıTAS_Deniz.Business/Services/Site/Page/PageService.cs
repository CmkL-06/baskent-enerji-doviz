...
using PageEntity = AnasıTAS_Deniz.Entity.Entities.Site.Page.Page;
using AnasıTAS_Deniz.Entity.Entities.Site.Page;
using AnasıTAS_Deniz.Entity.Modals.RequestModals.Site.Page;

namespace AnasıTAS_Deniz.Business.Services.Site.Page
{
    public class PageService : IPageService
    {
        ...
        public PageService(AnasıTAS_DenizDbContext dbContext, IMapper mapper)
        {
