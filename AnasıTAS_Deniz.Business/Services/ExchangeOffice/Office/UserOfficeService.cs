...
namespace AnasıTAS_Deniz.Business.Services.ExchangeOffice.Office
{
    public class UserOfficeService : IUserOfficeService
    {
        ...
        public UserOfficeService(AnasıTAS_DenizDbContext context, IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        }
        ...
        public async Task<List<AnasıTAS_Deniz.Entity.Modals.ViewModals.User.vm_user>> GetUsersByOfficeAsync(Guid officeId)
        {
            ...
            return _mapper.Map<List<AnasıTAS_Deniz.Entity.Modals.ViewModals.User.vm_user>>(users);
        }
    }
}