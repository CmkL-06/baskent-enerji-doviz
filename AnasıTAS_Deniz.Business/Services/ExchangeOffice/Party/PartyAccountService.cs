...
namespace AnasıTAS_Deniz.Business.Services.ExchangeOffice.Party
{
    public class PartyAccountService : IPartyAccountService
    {
        ...
        public PartyAccountService(AnasıTAS_DenizDbContext context, ILogger<PartyAccountService> logger, ValidationService validationService, IVaultService vaultService)
        {
            _context = context;
            _logger = logger;
