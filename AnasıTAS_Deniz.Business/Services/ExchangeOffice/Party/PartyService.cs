...
namespace AnasıTAS_Deniz.Business.Services.ExchangeOffice.Party
{
    public class PartyService : IPartyService
    {
        ...
        public PartyService(AnasıTAS_DenizDbContext context, ILogger<PartyService> logger, ValidationService validationService, ICacheClearService cacheClearService)
        {
            _context = context;
            _logger = logger;
