...
.od-stat-icon {
  font-size: 1.4rem; width: 44px; height: 44px; padding: 0; color: #fff;
...
.od-stat-icon.blue   { background: var(--color-secondary); }
.od-stat-icon.purple { background: #8b5cf6; }
.od-stat-icon.green  { background: #22c55e; }
.od-stat-icon.red    { background: var(--color-danger); }
.od-stat-icon.amber  { background: var(--color-warning); }
...
.od-office-card:hover { box-shadow: var(--shadow-bold); }
...
.od-perf-table th {
  ...
  color: var(--color-text-secondary); font-weight: 700; border-bottom: 2px solid var(--border-strong);
  white-space: nowrap;
}
