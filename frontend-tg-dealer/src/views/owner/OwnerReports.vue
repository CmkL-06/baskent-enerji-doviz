...
.or-table-wrap { overflow-x: auto; background: white; border-radius: var(--radius-lg); border: 1px solid var(--color-border); box-shadow: var(--shadow-md); }
.or-table { width: 100%; border-collapse: collapse; font-size: 0.85rem; }
.or-table th { text-align: left; padding: 0.75rem 1rem; background: var(--color-bg-page); color: var(--color-text-secondary); font-weight: 700; border-bottom: 2px solid var(--border-strong); }
...
.or-pnl-card { background: white; border-radius: var(--radius-lg); padding: 1rem; border: 1px solid var(--color-border); box-shadow: var(--shadow-md); }
.or-pnl-card.highlight { border: 2px solid var(--color-secondary); box-shadow: var(--shadow-glow-primary); }
