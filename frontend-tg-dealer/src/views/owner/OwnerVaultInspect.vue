...
.vi-bal-card {
  ...
  box-shadow: var(--shadow-md); border-left: 7px solid var(--color-secondary);
}
...
.vi-table-wrap { overflow-x: auto; background: white; border-radius: var(--radius-lg); border: 1px solid var(--color-border); box-shadow: var(--shadow-md); }
.vi-table { width: 100%; border-collapse: collapse; font-size: 0.85rem; }
.vi-table th { text-align: left; padding: 0.7rem 1rem; background: var(--color-bg-page); color: var(--color-text-secondary); font-weight: 700; border-bottom: 2px solid var(--border-strong); }
...
.vi-snap-card:hover { box-shadow: var(--shadow-bold); }
