...
// Not: her 30sn'lik/SSE tetiklemeli otomatik yenilemede loadData() ilk sayfayi
// yeniden cekiyor -- bu yuzden "daha fazla yukle" ile eklenen eski islemler bir
// sonraki otomatik yenilemede listeden dusebilir. Kucuk bir UX kisiti, ama varsayilan
// yukun sinirsiz buyumesini onlemek bunu telafi ediyor.
async function loadMoreTransactions() {
  ...
  try {
    ...
    // Bekleme sirasinda loadData() (30sn zamanlayici/SSE/gorunurluk) araya girip
    // dashboard.value'yu tamamen yenilemis olabilir -- id'ye gore tekilleyerek
    // ayni islemin iki kez (cakisan :key ile) render edilmesini onluyoruz.
