...
using BaskentEnerji.Entity.Modals.ResponseModals.Site.Menu;
...
using BaskentEnerji.Entity.Modals.ViewModals.Menu;
...
namespace BaskentEnerji.Business.Extensions
{
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile()
        {
          ...
          //  CreateMap<rsp_category_guest, Blog_Category>();
            ...
            CreateMap<User, BaskentEnerji.Entity.Modals.ViewModals.User.vm_user>();
