...
.op-crown { font-size: 2.5rem; color: #3b82f6; }
...
.op-alert-item:hover { background: #f8fafc; }
.op-alert-icon { font-size: 1.1rem; margin-top: 2px; flex-shrink: 0; }
.op-alert-body { flex: 1; min-width: 0; }
.op-alert-title { font-size: 0.8rem; font-weight: 600; color: #1e293b; }
.op-alert-msg { font-size: 0.75rem; color: #64748b; margin-top: 2px; line-height: 1.3; }
.op-alert-meta { font-size: 0.7rem; color: #94a3b8; margin-top: 3px; }
.op-alert-dismiss {
  background: none; border: none; cursor: pointer; color: #94a3b8;
  padding: 2px; border-radius: 4px; flex-shrink: 0;
}
.op-alert-dismiss:hover { color: #ef4444; background: #fef2f2; }
