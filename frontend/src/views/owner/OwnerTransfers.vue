...
.ot-title {
  display: flex; align-items: center; gap: 0.5rem; font-size: 1.1rem; font-weight: 700; color: var(--color-text); margin: 0;
...
.ot-title::before {
  ...
  background: var(--color-warning); border-radius: 3px;
}
...
.ot-transfer-card {
  ...
  box-shadow: var(--shadow-md); border-left: 7px solid var(--color-warning);
}
...
.ot-table-wrap { overflow-x: auto; background: white; border-radius: var(--radius-lg); border: 1px solid var(--color-border); box-shadow: var(--shadow-md); }
.ot-table { width: 100%; border-collapse: collapse; font-size: 0.875rem; }
.ot-table th { text-align: left; padding: 0.75rem 1rem; background: var(--color-bg-page); color: var(--color-text-secondary); font-weight: 700; border-bottom: 2px solid var(--border-strong); }
