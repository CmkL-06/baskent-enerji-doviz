...
{
    public class DesignTimeDbContextFactory : IDesignTimeDbContextFactory<BaskentEnerjiDbContext>
    {
        public BaskentEnerjiDbContext CreateDbContext(string[] args)
        {
            ...
            DbContextOptionsBuilder<BaskentEnerjiDbContext> dbContextOptionsBuilder = new();
            dbContextOptionsBuilder.UseSqlServer(connectionString);

            return new BaskentEnerjiDbContext(dbContextOptionsBuilder.Options);
        }
    }
